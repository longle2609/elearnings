        ...
        <footer className="footer relative">
            <div className="footer__sub f__contain">
                <div className="fSub__container">
                    <div className="fsub__item">
                        <h5 className="fsub__cate">Subscribe to E-Learning </h5>
            ...
            <div className="footer__info f__contain">
                <div className="fInfo__top">
                    <div className="fInfor__logo flex items-center italic">
                        <img src={logo} alt="logo" />
                        <span className="ml-3 font-bold ">E-Learning</span>
                    </div>
                ...
                <div className="fInfo__bottom">
                    <div className="copy__right">
                        ...
                        <span className="text-[#31d7a9]"> E-Learning</span>
                    </div>
